...
const Footer = () => {
  return (
    <footer className="bg-[#E1F7F5] text-[#1E0342] px-[8vh] pt-12 md:pt-28 pb-2 flex flex-col ">
      <div className="flex flex-col gap-y-6 md:gap-y-14">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-24">
          <div className="flex flex-col gap-y-3">
            <p className="text-sm md:text-lg font-light w-3/4">
          ...
          <div className="flex flex-col gap-y-6">
            <div className="flex gap-x-2">
              <Phone />
              <span className="text-base md:text-lg font-normal w-3/4">
                093916 07870
              </span>
            </div>
            {/* <div className="flex gap-x-2">
              <Mail />
              <span className="text-lg font-normal w-3/4">email@bmail.com</span>
            </div> */}
            <div className="flex gap-x-2">
              <Locate />
              <span className="text-base md:text-lg font-normal w-3/4">
